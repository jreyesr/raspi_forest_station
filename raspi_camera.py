...
conn.commit()
def saveimage(filename, timestamp):
	c.execute("INSERT INTO camera (timestamp, filename) VALUES (?,?)", (timestamp, filename))
	conn.commit()
...
while True:
	...
	filename = "/home/pi/images/photo_" + timestamp + ".jpg"
